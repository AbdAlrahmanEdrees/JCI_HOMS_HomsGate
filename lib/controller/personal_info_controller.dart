...
import 'package:trip/data/models/personal_info_model.dart';
import 'package:trip/data/remote/personal_info_data.dart';
...
class PersonalInfoController extends GetxController {
  ...
  getdetailsforproperty() async {
    var response = await personalInfoData.getPersonalInfo(
