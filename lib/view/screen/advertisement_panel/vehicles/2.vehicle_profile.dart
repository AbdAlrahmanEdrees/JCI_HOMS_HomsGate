...
class VehicleProfile extends StatelessWidget {
  ...
  const VehicleProfile({super.key, required this.vehicle});

  @override
  Widget build(BuildContext context) {
    final AdWidgetsAndTools adTools = AdWidgetsAndTools();
    final photos = adTools.splitCsv(vehicle.photos);
    final phones = adTools.splitCsv(vehicle.phoneNumbers);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.5,
        centerTitle: true,
        title: Text('vehicle_details'.tr(), style: AppTextStyles.h12b),
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text('vehicle_overview'.tr(), style: AppTextStyles.h11b),
                    SizedBox(height: 8.h),
                    Wrap(
                      spacing: 8.w,
                      runSpacing: 8.h,
                      children: [
                        ChipTag(
                          ...
                          label:
                              '${'governorate'.tr()}: ${vehicle.governorate.tr().capitalize}',
                        ),
                        ChipTag(
                          icon: Icons.shield,
                          label: '${'brand'.tr()}: ${vehicle.brand.capitalize}',
                        ),
                        ChipTag(
                          icon: Icons.calendar_today,
                          label: '${'year'.tr()}: ${vehicle.year}',
                        ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InfoRow(
                        ...
                        label: 'model'.tr(),
                        value: vehicle.model.capitalize!,
                      ),
                      if(vehicle.kilometersTraveled!=-404 || vehicle.kilometersTraveled>10000 || vehicle.kilometersTraveled==0)
                      ...[
                        adTools.dividerLight(),
                        InfoRow(
                          icon: Icons.speed,
                          label: 'kilometers_traveled'.tr(),
                          value: '${vehicle.kilometersTraveled}',
                        ),
                      ],
                      ...[
                        adTools.dividerLight(),
                        InfoRow(
                          ...
                          value: vehicle.transmission.tr(),
                        ),
                      ],
                      if(vehicle.forSale==0)
                      ...[
                        adTools.dividerLight(),
                        InfoRow(
                          icon: Icons.calendar_month,
                          label: 'rent'.tr(),
                          value: vehicle.typeOfRent.tr(),
                        ),
                      ],
                      adTools.dividerLight(),
                      InfoRow(
                        icon: Icons.attach_money,
                        label: vehicle.forSale==1? 'price'.tr(): 'rent',
                        value: '${vehicle.usPrice}',
                      ),
