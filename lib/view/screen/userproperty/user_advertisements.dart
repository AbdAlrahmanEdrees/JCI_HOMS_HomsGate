...
class UserAdvertisements extends StatelessWidget {
  const UserAdvertisements({super.key});
                ...
                userAdsIds.isEmpty
                    ? ListView(
                      children: [
                        ...
                        Icon(Icons.hotel, size: 48.sp, color: AppColors.brown),
                    ...
                    : ListView.separated(
                      ...
                      itemCount: userAdsIds.length,
                      separatorBuilder: (_, __) => SizedBox(height: 10.h),
                      itemBuilder: (context, index) {
                        final ad = userAdsIds[index];
